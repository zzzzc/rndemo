...
* @Last Modified time: 2016-12-14 16:57:36
*/
...
export default class Home extends React.Component {
  ...
  static navigationBarRouteMapper = {
    LeftButton(route, navigator, index, navState) {
      return(
        <TouchableOpacity style={[commonStyles.flexFirst,commonStyles.justifyCenter]} onPress={()=>index > 0 ? navigator.pop() : BackNativeView()}>
          <Text>返回</Text>
        </TouchableOpacity>
      );
    },
